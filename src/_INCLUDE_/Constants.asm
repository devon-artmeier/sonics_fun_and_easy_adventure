...
oDrawW		rs.b	1				; Sprite width
oDrawH		rs.b	1				; Sprite height
oPrio		rs.w	1				; Sprite priority
...
oFrame		rs.b	1				; Mapping frame ID
oAniFrame	rs.b	1				; Animation script frame ID
oAniTimer	rs.b	1				; Animation timer
oStatus		rs.b	1				; Status
oDynSSTs	rs.b	$4E-__rs			; Dynamic SSTs
...
oPrevDPLC	rs.b	1				; Save DPLC frame
...
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
		rsset	oLvlSSTs			; Allow some reserved SSTs
...
ct		=	0
	rept	5					; Allow 5 sub sprites per object
...
cur_obj_size	=	0
		while cur_obj_size<(\size)
r_Obj_\$cur_obj		rs.b	oSize
cur_obj_size		=	cur_obj_size+oSize
cur_obj			=	cur_obj+1
		endw
		endm
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
