...
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		opt	ws+				; Enable whitespace
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
; Required
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
GAME_NAME	equs	"SONIC'S FUN AND EASY ADVENTURE"; International name
...
NOTES		equs	"BAAAH, GET OUTTA MAH ROM, KID!"; Notes
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
; User defined
; ---------------------------------------------------------------------------------------------------------------------------------------------------------
DEBUG_BUILD	equ	0				; Debug build flag (0 = Disabled)
ENABLE_HANDLER	equ	0|DEBUG_BUILD			; Vladikcomper's error handler enable flag (0 = Disabled)
